      ...
      .addFields([
        {
          ...
          value: "`play` ' `stop` ' `skip` ' `loop` '  `clearqueue` ' `pause` ' `queue` ' `remove` ' `replay` '`resume` ' `volume`" // استخدم value هنا
        },
        
        {
          name: `<:1111768114405838928:1148945415551590441> Settings`,
          value: "`help` ' `247` ' `ping` ' `prefix`" // استخدم value هنا
        },
      ])
      .setFooter(client.getFooter(user));
